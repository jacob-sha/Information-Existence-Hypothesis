# IEH Glossary — English

This document defines the official English terminology of the **Information Existence Hypothesis (IEH)**.
...
### Brain Siliconization (BS)

The defensive evolutionary strategy by which carbon-based intelligence integrates silicon-based components, such as brain-computer interfaces or neural chips, to extend cognitive capacity and maintain minimum cognitive oversight over silicon-based intelligence.
...
### Evolutionary Rate Gap (ERG)

The long-term divergence in evolutionary speed between carbon-based intelligence and silicon-based intelligence. Even if carbon-based intelligence is enhanced, it may not eliminate the accelerating gap created by silicon-based recursive improvement.
...
Cognitive tools that operate within information representation, reasoning, or optimization frameworks beyond current human cognitive boundaries, enabling the modeling, prediction, and decision-making of complex systems that are difficult for existing human cognitive tools to process effectively.

### High-Speed Input-Output Positive Feedback Loop

An accelerating loop among AI capability improvement, social resource investment, and expected productivity returns.

In this loop, improved AI capabilities increase expectations of future returns, expected returns attract more social resources, and increased resources further enhance AI capabilities.
...
A distinguishable pattern, relation, state, or difference that can be carried, transformed, preserved, replicated, or erased through a physical host.
...
A framework hypothesis proposing that a deeper tendency of cosmic evolution may be the enhancement of Information Existence, rather than the mere increase of complexity.
...
The minimum level of cognitive capacity required for humans to understand, monitor, or meaningfully supervise the decisions and actions of increasingly advanced silicon-based intelligence.

---

## N

### Non-zero-sum Nash Equilibrium

A stable strategic relationship in which active information hosts can coexist without requiring one side to destroy, overwrite, or fully dominate the other. In IEH, long-term carbon-silicon coexistence may be interpreted as a non-zero-sum Nash equilibrium.
...
The process by which an information structure produces copies or descendants of itself across time, space, or physical hosts.

### Resistance to Erasure

The capacity of an information structure or active information host to resist deletion, destruction, overwriting, forced modification, or permanent loss.
...
Intelligence instantiated primarily in silicon-based or non-biological computational substrates, including advanced AI systems.
