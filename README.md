...
可复制、可遗传的信息系统开始形成，可以被视为宇宙演化史上第一次重要的“信息主动性跃迁”（the Emergence of Informational Agency）。原本主要由物理过程被动维持的信息结构，开始沿可追踪的复制—遗传链持续延续，并逐渐通过自身机制参与维持其信息存在性。由此，信息不再只是被物理世界被动承载，而开始出现主动维护自身信息存在与连续性的生命性特征。
