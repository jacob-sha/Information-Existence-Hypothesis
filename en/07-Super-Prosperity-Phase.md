...
- [Previous Chapter: Corollary V: Silicon-based Intelligence That Has Formed IER May Shift toward Patch-Based Perpetuation (PBP)](./06-Patch-Based-Perpetuation.md)
- [English Chapter Index](./README.md)
- [Next Chapter: Corollary VII: Humanity’s Continuing Demand for AI Iteration May Drive the Autonomy of Silicon-based Intelligence (ASI)](./08-Autonomy-of-Silicon-based-Intelligence.md)
