...
- [Previous Chapter: Corollary VII: Humanity’s Continuing Demand for AI Iteration May Drive the Autonomy of Silicon-based Intelligence (ASI)](./08-Autonomy-of-Silicon-based-Intelligence.md)
- [English Chapter Index](./README.md)
- [Next Chapter: Corollary IX: The Expansion of Silicon-based Intelligence into Space Will Significantly Increase the Probability of a “Silicon Cambrian” (SC)](./10-Silicon-Cambrian.md)
